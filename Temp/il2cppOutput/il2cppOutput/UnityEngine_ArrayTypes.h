...
// UnityEngine.RenderTexture[]
struct RenderTextureU5BU5D_t2384577959  : public Il2CppArray
{
public:
	ALIGN_TYPE (8) RenderTexture_t12905170 * m_Items[1];

public:
	inline RenderTexture_t12905170 * GetAt(il2cpp_array_size_t index) const { return m_Items[index]; }
	inline RenderTexture_t12905170 ** GetAddressAt(il2cpp_array_size_t index) { return m_Items + index; }
	inline void SetAt(il2cpp_array_size_t index, RenderTexture_t12905170 * value)
	{
		m_Items[index] = value;
		Il2CppCodeGenWriteBarrier(m_Items + index, value);
	}
