...
struct  ColorCorrectionMode_t1791592516 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(ColorCorrectionMode_t1791592516, ___value___1)); }
