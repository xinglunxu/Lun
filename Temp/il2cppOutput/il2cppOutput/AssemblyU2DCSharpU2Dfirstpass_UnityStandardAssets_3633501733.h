...
struct  BloomScreenBlendMode_t3633501733 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(BloomScreenBlendMode_t3633501733, ___value___1)); }
