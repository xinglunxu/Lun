...
struct  BlurSampleCount_t1310695038 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(BlurSampleCount_t1310695038, ___value___1)); }
